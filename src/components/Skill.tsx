...
const Skill: React.FC = () => {
    return (
        <div className='font-nunitosans py-6 mb-20'>
            ...
            <div className='container mx-auto flex items-center justify-between'>
                <div className='text-center w-max py-6 px-3 rounded-lg hover:shadow-lg duration-300'>
                    ...
                    <p className='text-lg text-[#585858] w-[380px] mx-auto'>Our Business Plan is a written document describing a company’s core business activities.</p>
                </div>
                <div className='text-center w-max py-6 px-3 rounded-lg hover:shadow-lg duration-300'>
                    ...
                    <p className='text-lg text-[#585858] w-[380px] mx-auto'>Our expert team sensible decision about their money, to ensure they achieve the life goals. A financial plan.</p>
                </div>
                <div className='text-center w-max py-6 px-3 rounded-lg hover:shadow-lg duration-300'>
                    ...
                    <p className='text-lg text-[#585858] w-[380px] mx-auto'>A market analysis is a quantitative and qualitative assessment of a market. It looks into the size of the market.</p>
                </div>
            </div>
        </div>
    )
